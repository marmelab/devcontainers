...
| --------------- | ---------------------------------------------------- | ------ | ------------------------------------------- |
| containerName   | Display name for the Dev Container                   | string | Node                                        |
| imageVariant    | Node image to use                                    | string | 24-trixie                                   |
| workspaceFolder | Path where the workspace is mounted in the container | string | /workspaces/${localWorkspaceFolderBasename} |
